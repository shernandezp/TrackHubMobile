...
The application authenticates against the TrackHub AuthorityServer with an in-app sign-in page (OAuth 2.0 password grant + refresh tokens), and consumes the Manager and Router GraphQL APIs.
